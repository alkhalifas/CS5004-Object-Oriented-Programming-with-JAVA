...
public class SVGAnimationViewTest {
  ...
  public void testGetAppendable2() {
    this.playbackBuilder.declareShape("Dave", "Rectangle")
            .addMotion("Dave", 0, 10, 10, 10, 30, 0, 255,
                    0, 5, 20,
                    10, 10, 30, 0, 255, 0)
            .addMotion("Dave", 5, 20, 10, 10, 30, 0, 255,
                    0, 10, 20,
                    20, 10, 30, 0, 255, 0)
  ...
  public void testMain2() {
    EasyAnimator.main(new String[]{"-in", "-out", "-view", "./starter_code/toh-3-output.svg",
        "./starter_code/toh-3.txt", "svg"});
    List<String> lines;
    try {
  ...
  @Test
  public void testMain3WithSpeed() {
