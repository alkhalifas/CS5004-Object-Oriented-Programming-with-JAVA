...
/**
 * This class represents the playbackview to hangle a pop up that will be used for an event.
 */
public class InputHandler implements InterfaceViewInputHandler {
  ...
  public void changeFrame(Component parent, FrameChange type, String id, int time, int x,
    ...
    //JPanel rotationDegreeDetail = new JPanel(new GridLayout(2, 1));
    //rotationDegreeDetail.add(pointLabel);
    //rotationDegreeDetail.add(rotationDegreeFields);
