...
public class TicTacToeModelTest {
  ...
  /**
   * A method to test the testMove() method using the move 0,0.
   */
  @Test
  ...
  /**
   * A method to test the testMove(), isGameOver(), and getWinner() methods using a horizontal win.
   */
  @Test
  ...
  /**
   * A method to test the isGameOver(), and getWinner() methods using a horizontal win.
   */
  @Test
  ...
  /**
   * A method to test the the situation in which the game is by definition over, and the board still
   * has a null value on it.
   */
  ...
  /**
   * A method to test the getTurn() and getMarkAt() in which an invalid move is used where a
   * location is already occupied by another player.
   */
  @Test
  ...
  /**
   * A method to test the throwing of a new IllegalStateException when testing a move after the game
   * has ended.
   */
  ...
  /**
   * A method to test the isGameOver(), and getWinner(), and the toString() methods.
   */
  @Test
  public void testCatsGame() {
    ...
    ttt1.move(2, 2);
    ttt1.move(2, 0);
    //System.out.println(ttt1.toString());
    assertTrue(ttt1.isGameOver());
    assertNull(ttt1.getWinner());
    assertEquals(" X | O | X\n"
            + "-----------\n"
  ...
  /**
   * A method to test the getMarkAt() method with an invalid row position.
   */
  ...
  /**
   * A method to test the getMarkAt() method with an invalid column position.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * A method to test the getBoard() method using a specific setup.
   */
  @Test
